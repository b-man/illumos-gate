 ...
 */
	...
	NO_UNLOAD_STUB(platmod, plat_hwreset_assert, nomod_minus_one);
	NO_UNLOAD_STUB(platmod, plat_hwreset_deassert, nomod_minus_one);
	NO_UNLOAD_STUB(platmod, plat_hwreset_is_asserted, nomod_minus_one);
	NO_UNLOAD_STUB(platmod, plat_hwclock_enable, nomod_minus_one);
	NO_UNLOAD_STUB(platmod, plat_hwclock_disable, nomod_minus_one);
	NO_UNLOAD_STUB(platmod, plat_hwclock_is_enabled, nomod_minus_one);
	END_MODULE(platmod);
