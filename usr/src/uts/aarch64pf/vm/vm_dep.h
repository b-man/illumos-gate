 ...
 * correct tick value.  The proper routine to use is csr_read_time().
 */
...
/*
 * macro to update page list max counts.  no-op on AArch64.
 */
...
/*
 * interleaved_mnodes mode is never set on AArch64, therefore,
...
/*
 * get the setsize of the current cpu - assume homogenous for AArch64
 */
